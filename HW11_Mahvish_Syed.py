...
class StudentReport:
    ...
    def __init__(self) -> None:
        ...
        self.row_list: List[List[str]] = list()
    ...
    def file_reader(self,
        ...
        function And yields tuple of str eliminating delimiters."""
    ...
    def read_major_file(self, path) -> None:
        ...
        for major, req_or_elec, course in self.file_reader(path, 3, "\t", True):
            ...
            if req_or_elec == "R":
                ...
                raise ValueError(f"Course : {course} is neither required nor elective")
        ...
        for key, values in self.major_summary.items():
            table.add_row(
                [key, values[REQUIRED_COURSES], values[ELECTIVE_COURSES]])
        print("\nMajors Summary\n")
        print(f"{table} \n\n")
    ...
    def read_instructor_file(self, grade_file_path: str, instructor_file_path: str) -> None:
        ...
        temp_instructor_dict: Dict[str: Dict[str: any]] = dict()
        table: PrettyTable = PrettyTable()

        for instructor_id, name, dept in self.file_reader(instructor_file_path, 3, "\t", True):
        ...
        for student_id, course, grades, instructor_id in self.file_reader(
                        grade_file_path, 4, "\t", True):
    ...
    def student_grades_table_db(self, db_path: str) -> None:
        ...
        and print result using pretty table"""
        ...
        table: PrettyTable = PrettyTable(field_names=["Name", "CWID", "Course",
                                                      "Grade", "Instructor"])

        print("\nStudent Grade Summary\n")
        for row in db_connect.execute(query):
    ...
    def read_input(self) -> None:
        ...
        try:
            ...
            self.student_grades_table_db("HW11_DB_File")
